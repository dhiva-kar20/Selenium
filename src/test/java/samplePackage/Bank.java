...
public class Bank {
	...
	if (message.equalsIgnoreCase("Deposit Successful")) {
		System.out.println("Balance amount is increases after deposit");
	} else {
		System.out.println("Balance amount is not increases after deposit");
	}
