...
public class ElementIdentification extends BrowserLaunch {
	

	@Test (priority = 0,groups = { "demo" })
	public void xpathLocator() {
		navigateUrl("https://ecommerce-playground.lambdatest.io/index.php?route=account/register");
	...
	public void selectsTag() {
		navigateUrl("https://testsheepnz.github.io/testing-ideas.html");
	...
	public void selectValue() {
		navigateUrl("https://testsheepnz.github.io/panther.html");
	...
	public void addFunctionality() throws InterruptedException {
		navigateUrl("https://testsheepnz.github.io/BasicCalculator.html");
